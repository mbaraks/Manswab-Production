...
const HERO_IMAGE =
  "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=1800&h=2200&fit=crop";
        ...
        <div className="grid gap-16 md:grid-cols-12 md:items-end md:gap-8">
          ...
          <div className="md:col-span-7">
            ...
            <p
              ...
              style={{ color: "#5A5A5A" }}
            >
              We believe wedding photography is about more than beautiful
              images. It is about preserving the people, emotions, and
              atmosphere that make your story uniquely yours.
            </p>
          </div>
          ...
          <div className="md:col-span-4 md:col-start-9">
            <div className="aspect-[3/4] overflow-hidden bg-[#F3EEE8]">
              <motion.img
                src={HERO_IMAGE}
                alt="Manswab Production photographer"
                initial={{
